...
/**
 * Gets the last fatal error code from the connection.
 *
 * @returns {number} - Returns the fatal error code.
 */
Client.prototype.fatalError = function() {
  return this._client.fatalError();
};

/**
 * Gets the last fatal error message from the connection.
 *
 * @returns {string} - Returns the fatal error message.
 */
Client.prototype.fatalErrorMessage = function() {
  return this._client.fatalErrorMessage();
};
